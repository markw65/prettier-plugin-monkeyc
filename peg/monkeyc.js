...
function peg$parse(input, options) {
  ...
  var peg$c119 = "--";
  var peg$c120 = "public";
  var peg$c121 = "protected";
  var peg$c122 = "hidden";
  var peg$c123 = "private";
  var peg$c124 = "Array";
  var peg$c125 = "Lang.Array";
  var peg$c126 = "Toybox.Lang.Array";
  var peg$c127 = "$.Toybox.Lang.Array";
  var peg$c128 = "or";
  ...
  var peg$e92 = peg$literalExpectation("static", false);
  var peg$e93 = peg$literalExpectation("super", false);
  var peg$e94 = peg$literalExpectation("switch", false);
  var peg$e95 = peg$literalExpectation("throw", false);
  var peg$e96 = peg$literalExpectation("true", false);
  var peg$e97 = peg$literalExpectation("try", false);
  var peg$e98 = peg$literalExpectation("typeof", false);
  var peg$e99 = peg$literalExpectation("typedef", false);
  var peg$e100 = peg$literalExpectation("using", false);
  var peg$e101 = peg$literalExpectation("var", false);
  var peg$e102 = peg$literalExpectation("void", false);
  var peg$e103 = peg$literalExpectation("while", false);
  ...
  var peg$e151 = peg$literalExpectation("public", false);
  var peg$e152 = peg$literalExpectation("protected", false);
  var peg$e153 = peg$literalExpectation("hidden", false);
  var peg$e154 = peg$literalExpectation("private", false);
  var peg$e155 = peg$literalExpectation("Array", false);
  var peg$e156 = peg$literalExpectation("Lang.Array", false);
  var peg$e157 = peg$literalExpectation("Toybox.Lang.Array", false);
  var peg$e158 = peg$literalExpectation("$.Toybox.Lang.Array", false);
  ...
  var peg$f11 = function() {
        return wrap({ type: "Literal", value: parseFloat(text()), raw: text() });
      };
  ...
  var peg$f24 = function(pattern, flags) {
        var value;
  ...
  var peg$f26 = function(expression) { return wrap(expression); };
  ...
  var peg$f34 = function() { return wrap({ type: "ObjectExpression", properties: [] }); };
  var peg$f35 = function(properties) {
  ...
  var peg$f38 = function(id) { return [id]; };
  var peg$f39 = function(size) {
          return wrap({
            type: "ArrayLiteral",
            size
          })
  ...
  var peg$f50 = function(args) { return optionalList(args); };
  var peg$f51 = function(operator, argument) {
        return wrap({
  ...
  var peg$f56 = function(argument, operator) {
        return wrap({
  ...
  var peg$f62 = function(attrs, kind, declarations) {
        return wrap({
  ...
  var peg$f63 = function(id, ts, init) {
        id.ts = ts;
        return wrap({
  ...
  var peg$f64 = function(expression) { return expression; };
  ...
  var peg$f68 = function(body, test) { return wrap({ type: "DoWhileStatement", body: body, test: test }); };
  var peg$f69 = function(test, body) {
  ...
  var peg$f71 = function(declarations) {
            return wrap({
              type: "VariableDeclaration",
              declarations,
              kind: "var",
  ...
  var peg$f73 = function(label) {
        return wrap({ type: "ContinueStatement", label });
      };
  var peg$f74 = function() { return wrap({ type: "BreakStatement", label: null }); };
  ...
  var peg$f77 = function(argument) {
        return wrap({ type: "ReturnStatement", argument: argument });
      };
  var peg$f78 = function(discriminant, cases) {
        return wrap({
  ...
  var peg$f79 = function(clauses) { return optionalList(clauses); };
  var peg$f80 = function(before, default_, after) {
        return optionalList(before).concat(default_).concat(optionalList(after));
      };
  var peg$f81 = function(id) {
        return wrap({
          type: "InstanceOfCase",
          id: id,
        });
      };
  var peg$f82 = function(test, consequent) {
        return wrap({
          type: "SwitchCase",
          test: test,
  ...
  var peg$f83 = function(consequent) {
        return wrap({
          type: "SwitchCase",
          test: null,
          consequent: optionalList(consequent),
  ...
  var peg$f84 = function(label, body) {
  ...
  var peg$f86 = function(block, handler, finalizer) {
        return wrap({
          type: "TryStatement",
          block: block,
          handler: handler,
  ...
  var peg$f87 = function(block, handler) {
        return wrap({
          type: "TryStatement",
          block: block,
          handler: handler,
  ...
  var peg$f88 = function(block, finalizer) {
        return wrap({
          type: "TryStatement",
          block: block,
          handler: null,
  ...
  var peg$f90 = function(block) { return block; };
  var peg$f91 = function() { return wrap({ type: "DebuggerStatement" }); };
  ...
  var peg$f100 = function(attrs, id, superClass, body) {
        return wrap({
  ...
  var peg$f102 = function(access, item) {
        return wrap({
          type: "ClassElement",
          access,
          item,
  ...
  var peg$f103 = function(stat, func) {
  ...
  var peg$f108 = function(attrs, id, params, ts, body) {
        return wrap({
  ...
  var peg$f109 = function(name, arg) {
        return wrap({
          type: "TypeSpecPart",
          name,
          arg,
  ...
  var peg$f110 = function(id) {
        return wrap({
          type: "TypeSpecPart",
          name: id.name,
        });
      };
  var peg$f111 = function(ts, opt) {
  ...
  var peg$f113 = function(ts) { return wrap({ type: "AsTypeSpec", ts }); };
  var peg$f114 = function(id, ts) {
        id.ts = ts;
        return id;
      };
  var peg$f115 = function(body) {
        return wrap({
          type: "Program",
          body: optionalList(body),
        });
  ...
  function peg$parseFunctionElement() {
    ...
    function wrap(value) {
      ...
      value.start = value.location.start.offset;
      value.end = value.location.end.offset;
      return value;
    }
