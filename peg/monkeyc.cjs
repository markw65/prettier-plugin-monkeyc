...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c363 = function(object, body) { return { type: "WithStatement", object: object, body: body }; },
      peg$c364 = function(discriminant, cases) {
            return {
      ...
      peg$c377 = function(id) { return {
          type: "SymbolName",
          name: ":" + id.name
        }},
      peg$c378 = function(sym, arg) {
          return { type: "Attribute", name: sym.name, arg: extractOptional(arg, 3) }
        },
      peg$c379 = function(head, tail) {
          return buildList(head, tail, 3);
        },
      peg$c380 = function(attrs) { return attrs; },
      peg$c381 = function(head, tail) { return {
              type: "ScopedIdentifier",
              name: extractList(buildList(head, tail, 3), "name").join(".")
            };
          },
      peg$c382 = function(attrs, id, params, ts, body) {
            return {
      ...
      peg$c384 = "Array",
      peg$c385 = peg$literalExpectation("Array", false),
      peg$c386 = "Lang.Array",
      peg$c387 = peg$literalExpectation("Lang.Array", false),
      peg$c388 = "Toybox.Lang.Array",
      peg$c389 = peg$literalExpectation("Toybox.Lang.Array", false),
      peg$c390 = "$.Toybox.Lang.Array",
      peg$c391 = peg$literalExpectation("$.Toybox.Lang.Array", false),
      ...
      peg$c398 = "as",
      peg$c399 = peg$literalExpectation("as", false),
      peg$c400 = function(ts) {
          return extractOptional(ts, 3)
        },
      peg$c401 = function(id, ts) {
          id.ts = ts;
          return id;
        },
  ...
  function peg$parseArrayTypeSpec() {
    ...
    if (s1 === peg$FAILED) {
      ...
      if (s1 === peg$FAILED) {
        ...
        if (s1 === peg$FAILED) {
          if (input.substr(peg$currPos, 19) === peg$c390) {
            s1 = peg$c390;
            peg$currPos += 19;
          } else {
            s1 = peg$FAILED;
